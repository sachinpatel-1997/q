...
const Header = () => {
  return (
    <>
        <div className="RootWrapperHeader">
            <div className="TopHeader">
                <div className="container">
                    <div className='logo'>
                    <img src={logo}
			alt="image of TransparentLogoTextAndRound1"
...
<path d="M10 11.3333C11.3807 11.3333 12.5 10.214 12.5 8.83325C12.5 7.45254 11.3807 6.33325 10 6.33325C8.61929 6.33325 7.5 7.45254 7.5 8.83325C7.5 10.214 8.61929 11.3333 10 11.3333Z" stroke="#43DF9A" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
</g>
<defs>
...
<rect width="20" height="20" fill="white" transform="translate(0 0.5)"/>
    ...
    <select name="cars" className="dropdown">
      ...
      <option value="audi">Audi</option>
                        ...
                        <form className="form">
    <input className="search__input1" type="text" placeholder="Find Your Perfect Sale" />
    ...
    <i class="fa fa-search"></i>
      {/* <img src="./search-normal.png"/> */}
                ...
                <div className="Frame5">
                    <span className='KiaOraAotearoa'>
                    Kia Ora, Aotearoa!
                    </span>
                    <span className="_22Jan2022">
                    22 Jan, 2022
                    </span>
                </div>
...
<rect width="20" height="20" fill="white"/>
                  ...
                  <div className="categories">Map</div>
                </div>
              </button>
              <div className="div12">
                <div className="a4">
                  <div className="div13"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M20.59 22C20.59 18.13 16.74 15 12 15C7.26 15 3.41 18.13 3.41 22" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  ...
                  <div className="how-it-works">Vendor Login</div>
                </div>
